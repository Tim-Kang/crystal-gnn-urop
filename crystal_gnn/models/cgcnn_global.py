...
class CGCNNGlobal(BaseModule):
    ...
    def __init__(self, _config: Dict[str, Any]) -> None:
        ...
        self.global_lin = nn.Linear(1521, self.hidden_dim)
    ...
    def forward(self, data: Union[Data, Batch]) -> torch.Tensor:
        ...
        # Process global features
        global_feats = torch.tensor(data.global_feats, dtype=self.dtype)  # [B, 1521]
        global_feats = fn_softplus(self.global_lin(global_feats))  # [B, H]

        # Add global features to node features
        node_feats = node_feats + global_feats  # [B, H]
        return node_feats
